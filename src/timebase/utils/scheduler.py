...
class Scheduler:
    def __init__(
        ...
        Args:
            ...
            checkpoint_dir: str, checkpoint directory to store model states
        ...
        self.lr_wait = 0
        if not 0 <= factor <= 1:
            raise ValueError("factor must be within 0 to 1.")
        self.factor = factor
    ...
    def _parameters2save(self):
        """Select parameters to save if self.module_names is specified,
